...
class Camera(object):
    ...
    def __init__(self, image_size, near, far, fov_width):
        ...
        In:
            ...
            fov_width: float, field of view in width direction in degree.
        Out:
            None.
        Purpose:
    ...
    def compute_camera_matrix(self):
        ...
        intrinsic_matrix[0,0] = self.fov_height
        intrinsic_matrix[1,1] = self.fov_width
        intrinsic_matrix[0,2] = self.image_size[0]/2.0
        intrinsic_matrix[1,2] = self.image_size[1]/2.0
        
        projection_matrix = p.computeProjectionMatrixFOV(self.fov_height, self.image_size[1]/self.image_size[0], self.near, self.far)  
